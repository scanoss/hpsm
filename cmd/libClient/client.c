...
int main() {
   //those are the hashes of the sample local source code. 
   //hashes can be created by using the library function HashFileContents
   ...
   //md5 is the key of the OSS file.
   char *md5;
   asprintf(&md5,"04d93973aafdb9e2b3474546378a9085");
  
  struct ranges r = HPSM(arr,109,md5);
