...
creating a shared library (.so or .dll) by doing remote Calculation of HPSM
on a gRPC service
...
By default, HPSM service is running on development server
Service address can be set by using Enviroment variable HPSM_URL
*/
